<?php
// Version: 2009-06-09
// �ltima vers�o dispon�vel em http://idp.ua.pt/common/SP-demo/
//
...
if ($status == '10' ) {
    echo '<tr>';
    echo '<td colspan=2><b>Sess�o Shibboleth v�lida, mas n�o possui atributos de utilizador!</b></td>';
    echo '</tr>';
    echo '<tr>';
    echo '<td colspan=2>Informe os administradores do IdP da sua Institui��o/Organiza��o:<br>Por favor verifique a metadata e os ficheiros de mapping e filtering.</td>';
    echo '</tr>';
}

elseif ($status == '00') {
    echo '<tr>';
    echo '<td colspan=2><b>Sess�o Shibboleth n�o presente!</b></td>';
    echo '</tr>';
    echo '<tr>';
    echo '<td colspan=2>Esta p�gina web provavelmente n�o est� protegida por Shibboleth.<br>Informe os administradores do IdP da sua Institui��o/Organiza��o:<br>Por favor verifique o servidor web a metadata e a configura��o Shibboleth</td>';
    echo '</tr>';
}
...
<?php
    ...
    $username= $_SERVER['HTTP_UAFULLNAMENOSP'];
        $con=mysqli_connect("mysql-sa.mgmt.ua.pt","deca-wave-dbo","tMBNA9C6sex2LYCD","deca-wave");
// Check connection
if (mysqli_connect_errno()) {
  echo "Failed to connect to MySQL: " . mysqli_connect_error();
}
        $query = "INSERT INTO USERS (`name`, `email`, `foto`, `type`) VALUES ('$username', '$token', NULL, 1)";
...
mysqli_close($con);
    ...
    if (isset($_REQUEST['all_variables'])) {
        echo ' | <a href=".">Esconder todas as vari�veis HTTP</a>';
    }
    else {
        echo ' | <a href="?all_variables">Mostrar todas as vari�veis HTTP</a>';
    }
?>
 | <a href="?source">Mostrar c�digo PHP</a>
    </td>
</tr>
<?php
//}`
...
<p>&nbsp;</p>
    <table>
        <tr>
            <td><strong>Vari�veis de ambiente HTTP</strong></td><td><strong>Valores n�o processados</strong></td></tr>
        <?php
        ksort($_SERVER);
        foreach ($_SERVER as $key => $value) {
